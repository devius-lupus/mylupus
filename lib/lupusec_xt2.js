...
/**
* Todo: 
* Status Übersicht: http://<ip>/action/panelCondGet
...
exports.list_param = function() {
    var options = {
        host: process.env.LUPUSEC_IP,
        port: 443,
        path: '/action/deviceListGet',
        headers: {
            'Authorization': 'Basic ' + new Buffer(process.env.LUPUSEC_USER + ':' + process.env.LUPUSEC_PW).toString('base64'),
